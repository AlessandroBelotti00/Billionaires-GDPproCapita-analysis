...
def add_continent(category_list,USA_GDP):
    ...
    country_world = pd.read_csv("./original_data/countries and continents.csv") # this dataset is used only for classify the residence continents of billionaires
...
def match_fixing(category_list,world_GDP):
